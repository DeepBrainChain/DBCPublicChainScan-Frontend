...
const VerifiedContracts = () => {
  ...
  const typeFilter = (
    <VerifiedContractsFilter onChange={handleTypeChange} defaultValue={type} isActive={Boolean(type)} />
  );
  ...
  const filterInput = (
    <FilterInput
      ...
      placeholder={t('deep_search_by_contract_name_or_address')}
  ...
  return (
    <Box>
      <PageTitle title={t('deep_verified_contracts')} withTextAd />
      <VerifiedContractsCounters />
      <DataListDisplay
        isError={isError}
        items={data?.items}
        emptyText={t('deep_no_verified_contracts')}
        filterProps={{
