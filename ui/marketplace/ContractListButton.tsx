...
const ContractListButton = ({ children, onClick, variant, isLoading }: Props) => {
  ...
  return (
    <Tooltip label={tooltip} textAlign="center" padding={2} isDisabled={!tooltip} openDelay={500} width="250px">
      <Skeleton
        isLoaded={!isLoading}
        display="inline-flex"
        alignItems="center"
        ...
        borderRadius="base"
      >
        <Link fontSize="sm" onClick={onClick} fontWeight="500" display="inline-flex">
